...
CRITICAL_SECTION	CTablemap::cs_tablemap;
...
CTablemap::CTablemap(void)
{
    ...
    InitializeCriticalSectionAndSpinCount(&cs_tablemap, 4000);
...
CTablemap::~CTablemap(void)
{
    ...
    DeleteCriticalSection(&cs_tablemap);

    __SEH_LOGFATAL("CTablemap::Destructor : \n");
}
