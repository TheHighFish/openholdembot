...
int	const num_s$strings = 57;
char * const s$strings[57] = { "titletext", "titletext0", "titletext1", "titletext2", "titletext3", "titletext4", "titletext5", "titletext6",
							   ...
							   "c0limits8", "c0limits9", 
							   "sitename", "network", "nchairs", "reseller", "mechanic", "chairconfig", "swagtextmethod", "potmethod", "defaultlabels",
