...
{		
	...
	{
		write_log(preferences.debug_table_positioner(), "[CTablePositioner] Going to tile %d windows...\n", number_of_child_windows);
	...
	{
		write_log(preferences.debug_table_positioner(), "[CTablePositioner] Going to cascade %d windows...\n", number_of_child_windows);
	...
	else
	{
		...
		write_log(preferences.debug_table_positioner(), "[CTablePositioner] Not doing anything because of preferences.\n");
	}
}