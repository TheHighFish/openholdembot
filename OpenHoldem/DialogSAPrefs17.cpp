...
BOOL CDlgSAPrefs17::OnInitDialog()
{
	...
	m_ConfigurationInputSettings_Button.SetCheck(theApp.p_preferences()->configurationcheck_input_settings() != 0);
	m_ConfigurationThemeSettings_Button.SetCheck(theApp.p_preferences()->configurationcheck_theme_settings() != 0);
	m_ConfigurationFontSettings_Button.SetCheck(theApp.p_preferences()->configurationcheck_font_settings() != 0);
...
{
	theApp.p_preferences()->SetValue(k_prefs_configurationcheck_input_settings, m_ConfigurationInputSettings_Button.GetCheck());
	theApp.p_preferences()->SetValue(k_prefs_configurationcheck_theme_settings, m_ConfigurationThemeSettings_Button.GetCheck());
	theApp.p_preferences()->SetValue(k_prefs_configurationcheck_font_settings, m_ConfigurationFontSettings_Button.GetCheck());
	CSAPrefsSubDlg::OnOK();
}
