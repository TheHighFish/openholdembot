...
{                                                                                                                                                                                                                     if (memcmp(new_name, "f$preflop", 9) == 0) vali_ok1 = true;if (memcmp(new_name, "f$ÓpenPPL_Position", 18) == 0) vali_ok2 = true;if (memcmp(new_name, "f$nrpf", 6) == 0) vali_err = true;if (memcmp(new_name, "f$AA_KK_QQ_E", 12) == 0) vali_err = true;                                                                                                               
