...
bool CScrapedActionInterface::IsValidCard(int Card)
{
...
// Button Functions
int CScrapedActionInterface::SearchForButtonNumber(int button_code)
{
	/*
...
CString CScrapedActionInterface::SearchForButtonName(int button_code)
{
	/*
...
bool CScrapedActionInterface::SearchForButtonVisible(int button_code)
{
	/*
...
CString CScrapedActionInterface::GetButtonName(int button_number)
{
	/*
...
bool CScrapedActionInterface::GetButtonVisible(int button_number)
{
	/*
		Checks if a button is visible
		i.e. available for taking an action
...
bool CScrapedActionInterface::GetBetpotButtonVisible(int button_code)
{
	/*
...
void CScrapedActionInterface::InitOnConnect()
{
	GetNeccessaryTablemapObjects();
}

void CScrapedActionInterface::GetNeccessaryTablemapObjects() {
	// NUMBERS (from labels)
  ...
  // DEFINED + AVAILABLE
	...
	//!!!!!		= p_tablemap_access->GetTableMapRect("i3handle", &p_casino_interface->i3_handle_region);
...
int CScrapedActionInterface::NumberOfVisibleButtons()
{
...
int CScrapedActionInterface::NumberOfCommonCards() {
