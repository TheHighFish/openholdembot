...
static const char *k_code_snippet_technical_functions =
	...
	"// and recall it later.\n"
	"[f$OpenPPL_Decision == f$OpenPPL_Action_SitOut] ? me_st_GoBuddyTakeABreakAndABeer_1 : 0\n"
	"\n"
	"##f$alli##\n"
	...
	"+ [   (f$OpenPPL_Decision == f$OpenPPL_Action_RaiseMax)\n"
	...
	"##f$rais##\n"
	"   [f$betsize > 0]\n"
	"|| [f$OpenPPL_Decision == f$OpenPPL_Action_Raise]\n"
	"\n"
	"##f$call##\n"
	"   f$rais\n"
	"|| [f$OpenPPL_Decision == f$OpenPPL_Action_Check]\n"
	"|| [f$OpenPPL_Decision == f$OpenPPL_Action_Call]\n"
