...
const double CSymbols::GetSymbolVal(const char *a, int *e)
{
	...
	if (memcmp(a, "nopponents", 10)==0)
	{
		...
		if (memcmp(a, "nopponentsseated", 16)==0 && strlen(a)==16)			return symbol_engine_active_dealt_playing.nopponentsseated();
		if (memcmp(a, "nopponentsactive", 16)==0 && strlen(a)==16)			return symbol_engine_active_dealt_playing.nopponentsactive();
		if (memcmp(a, "nopponentsdealt", 15)==0 && strlen(a)==15)			return symbol_engine_active_dealt_playing.nopponentsdealt();
		if (memcmp(a, "nopponentsplaying", 17)==0 && strlen(a)==17)			return symbol_engine_active_dealt_playing.nopponentsplaying();
		if (memcmp(a, "nopponentsblind", 15)==0 && strlen(a)==15)			return symbol_engine_blinds.nopponentsblind();
		if (memcmp(a, "nopponentschecking", 18)==0 && strlen(a)==18)		return symbol_engine_raisers_callers.nopponentschecking();
		if (memcmp(a, "nopponentscalling", 17)==0 && strlen(a)==17)			return symbol_engine_raisers_callers.nopponentscalling();
		if (memcmp(a, "nopponentsraising", 17)==0 && strlen(a)==17)			return symbol_engine_raisers_callers.nopponentsraising();
		if (memcmp(a, "nopponentsbetting", 17)==0 && strlen(a)==17)			return symbol_engine_raisers_callers.nopponentsbetting();
		if (memcmp(a, "nopponentsfolded", 16)==0 && strlen(a)==16)			return symbol_engine_raisers_callers.nopponentsfolded();
	}
	...
	{
		// PLAYERS OPPONENTS 2(7
		if (memcmp(a, "nplayersseated", 14)==0 && strlen(a)==14)			return symbol_engine_active_dealt_playing.nplayersseated();
		if (memcmp(a, "nplayersactive", 14)==0 && strlen(a)==14)			return symbol_engine_active_dealt_playing.nplayersactive();
		if (memcmp(a, "nplayersdealt", 13)==0 && strlen(a)==13)				return symbol_engine_active_dealt_playing.nplayersdealt();
		if (memcmp(a, "nplayersplaying", 15)==0 && strlen(a)==15)			return symbol_engine_active_dealt_playing.nplayersplaying();
		if (memcmp(a, "nplayersblind", 13)==0 && strlen(a)==13)				return symbol_engine_blinds.nplayersblind();
		if (memcmp(a, "nplayerscallshort", 17)==0 && strlen(a)==17)			return symbol_engine_raisers_callers.nplayerscallshort();

		// HISTORY 2(3)
		if (memcmp(a, "nplayersround", 13)==0 && strlen(a)==13)				return symbol_engine_history.nplayersround(_betround)
		if (memcmp(a, "nplayersround", 13)==0 && strlen(a)==14)				return symbol_engine_history.nplayersround(a[13]-'0');
	}

	// PLAYERS OPPONENTS 4(7)	
	if (memcmp(a, "nchairs", 7)==0)
	{
		if (memcmp(a, "nchairsdealtright", 17)==0 && strlen(a)==17)			return symbol_engine_positions.nchairsdealtright();
		if (memcmp(a, "nchairsdealtleft", 16)==0 && strlen(a)==16)			return symbol_engine_positions.nchairsdealtleft();
	}

	// PLAYERS OPPONENTS 5(7)
	if (memcmp(a, "players", 7)==0)
	{
		if (memcmp(a, "playersseatedbits", 17)==0 && strlen(a)==17)			return symbol_engine_active_dealt_playing.nplayersseated();
		if (memcmp(a, "playersactivebits", 17)==0 && strlen(a)==17)			return symbol_engine_active_dealt_playing.playersactivebits();
		if (memcmp(a, "playersdealtbits", 16)==0 && strlen(a)==16)			return symbol_engine_active_dealt_playing.playersdealtbits();
		if (memcmp(a, "playersplayingbits", 18)==0 && strlen(a)==18)		return symbol_engine_active_dealt_playing.playersplayingbits();
		if (memcmp(a, "playersblindbits", 16)==0 && strlen(a)==16)			return symbol_engine_blinds.playersblindbits();
	}

	// PLAYERS OPPONENTS 6(7)
	if (memcmp(a, "opponents", 9)==0)
	{
		if (memcmp(a, "opponentsseatedbits", 19)==0 && strlen(a)==19)		return symbol_engine_active_dealt_playing.opponentsseatedbits();
		if (memcmp(a, "opponentsactivebits", 19)==0 && strlen(a)==19)		return symbol_engine_active_dealt_playing.opponentsactivebits();
		if (memcmp(a, "opponentsdealtbits", 18)==0 && strlen(a)==18)		return symbol_engine_active_dealt_playing.opponentsdealtbits();
		if (memcmp(a, "opponentsplayingbits", 20)==0 && strlen(a)==20)		return symbol_engine_active_dealt_playing.opponentsplayingbits();
		if (memcmp(a, "opponentsblindbits", 18)==0 && strlen(a)==18)		return symbol_engine_blinds.opponentsblindbits();
	}

	// LIST TESTS 1(2)
	if (memcmp(a, "islist", 6) == 0)	return symbol_engine_lists.IsList(atoi(a+6));
	...
	{
		if (memcmp(a, "handrank169", 11)==0 && strlen(a)==11)	return symbol_engine_handrank.handrank169;
		if (memcmp(a, "handrank2652", 12)==0 && strlen(a)==12)	return symbol_engine_handrank.handrank2652;
		if (memcmp(a, "handrank1326", 12)==0 && strlen(a)==12)	return symbol_engine_handrank.handrank1326;
		if (memcmp(a, "handrank1000", 12)==0 && strlen(a)==12)	return symbol_engine_handrank.handrank1000;
		if (memcmp(a, "handrankp", 9)==0 && strlen(a)==9)		return symbol_engine_handrank.handrankp;
	}

	// NHANDS 1(2)
	if (memcmp(a, "nhands", 6)==0)
	{
		if (memcmp(a, "nhands", 6)==0 && strlen(a)==6)			return symbol_engine_prwin.nhands();
		if (memcmp(a, "nhandshi", 8)==0 && strlen(a)==8)		return symbol_engine_prwin.nhandshi();
		if (memcmp(a, "nhandslo", 8)==0 && strlen(a)==8)		return symbol_engine_prwin.nhandslo();
		if (memcmp(a, "nhandsti", 8)==0 && strlen(a)==8)		return symbol_engine_prwin.nhandsti();
	}
	...
	{
		if (memcmp(a, "rankhi", 6)==0 && strlen(a)==6)						return symbol_engine_pokerval.rankhi();
		if (memcmp(a, "rankhicommon", 12)==0 && strlen(a)==12)				return symbol_engine_pokerval.rankhicommon();
		if (memcmp(a, "rankhiplayer", 12)==0 && strlen(a)==12)				return symbol_engine_pokerval.rankhiplayer();
		if (memcmp(a, "rankhipoker", 11)==0 && strlen(a)==11)				return symbol_engine_pokerval.rankhipoker();
	}
	...
	{
		if (memcmp(a, "srankhi", 7)==0 && strlen(a)==7)						return symbol_engine_pokerval.srankhi();
		if (memcmp(a, "srankhicommon", 13)==0 && strlen(a)==13)				return symbol_engine_pokerval.srankhicommon();
		if (memcmp(a, "srankhiplayer", 13)==0 && strlen(a)==13)				return symbol_engine_pokerval.srankhiplayer();
		if (memcmp(a, "srankhipoker", 12)==0 && strlen(a)==12)				return symbol_engine_pokerval.srankhipoker();
	}
	...
	{
		if (memcmp(a, "ranklo", 6)==0 && strlen(a)==6)						return symbol_engine_pokerval.ranklo();
		if (memcmp(a, "ranklocommon", 12)==0 && strlen(a)==12)				return symbol_engine_pokerval.ranklocommon();
		if (memcmp(a, "rankloplayer", 12)==0 && strlen(a)==12)				return symbol_engine_pokerval.rankloplayer();
		if (memcmp(a, "ranklopoker", 11)==0 && strlen(a)==11)				return symbol_engine_pokerval.ranklopoker();
	}
	...
	{
		if (memcmp(a, "sranklo", 7)==0 && strlen(a)==7)						return symbol_engine_pokerval.sranklo();
		if (memcmp(a, "sranklocommon", 13)==0 && strlen(a)==13)				return symbol_engine_pokerval.sranklocommon();
		if (memcmp(a, "srankloplayer", 13)==0 && strlen(a)==13)				return symbol_engine_pokerval.srankloplayer();
		if (memcmp(a, "sranklopoker", 12)==0 && strlen(a)==12)				return symbol_engine_pokerval.sranklopoker();
	}
	...
	{
		if (memcmp(a, "randomheartbeat", 15)==0 && strlen(a)==15)			return symbol_engine_random.randomheartbeat();
		if (memcmp(a, "randomhand", 10)==0 && strlen(a)==10)				return symbol_engine_random.randomhand();
		if (memcmp(a, "randomround", 11)==0 && strlen(a)==11)				return symbol_engine_random.randomround();
		if (memcmp(a, "random", 6) == 0 && strlen(a)==6)					return symbol_engine_random.random();
	}
	...
	if (memcmp(a, "did", 3) == 0)
	{
		if (memcmp(a, "didchec", 7)==0 && strlen(a)==7)						return symbol_engine_history.didchec(_betround)
		if (memcmp(a, "didcall", 7)==0 && strlen(a)==7)						return symbol_engine_history.didcall(_betround)
		if (memcmp(a, "didrais", 7)==0 && strlen(a)==7)						return symbol_engine_history.didrais(_betround)
		if (memcmp(a, "didswag", 7)==0 && strlen(a)==7)						return symbol_engine_history.didswag(_betround)
		if (memcmp(a, "didchecround", 12)==0 && strlen(a)==13)				return symbol_engine_history.didchec(a[12]-'0');
		if (memcmp(a, "didcallround", 12)==0 && strlen(a)==13)				return symbol_engine_history.didcall(a[12]-'0');
		if (memcmp(a, "didraisround", 12)==0 && strlen(a)==13)				return symbol_engine_history.didrais(a[12]-'0');
		if (memcmp(a, "didswaground", 12)==0 && strlen(a)==13)				return symbol_engine_history.didswag(a[12]-'0');
	}	
	...
	{
		if (memcmp(a, "rankbits", 8)==0 && strlen(a)==8)					return symbol_engine_pokerval.rankbits();
		if (memcmp(a, "rankbitscommon", 14)==0 && strlen(a)==14)			return symbol_engine_pokerval.rankbitscommon();
		if (memcmp(a, "rankbitsplayer", 14)==0 && strlen(a)==14)			return symbol_engine_pokerval.rankbitsplayer();
		if (memcmp(a, "rankbitspoker", 13)==0 && strlen(a)==13)				return symbol_engine_pokerval.rankbitspoker();
	}

	// SRANK BITS 2(2)
	if (memcmp(a, "srankbits", 9)==0)
	{
		if (memcmp(a, "srankbits", 9)==0 && strlen(a)==9)					return symbol_engine_pokerval.srankbits;
		if (memcmp(a, "srankbitscommon", 15)==0 && strlen(a)==15)			return symbol_engine_pokerval.srankbitscommon;
		if (memcmp(a, "srankbitsplayer", 15)==0 && strlen(a)==15)			return symbol_engine_pokerval.srankbitsplayer;
		if (memcmp(a, "srankbitspoker", 14)==0 && strlen(a)==14)			return symbol_engine_pokerval.srankbitspoker;
	}
	
	// TIME 1(2)
	if (memcmp(a, "elapsed", 7)==0)
	{
		if (memcmp(a, "elapsed", 7)==0 && strlen(a)==7)			return symbol_engine_time.elapsed();
		if (memcmp(a, "elapsedhand", 11)==0 && strlen(a)==11)	return symbol_engine_time.elapsedhand();
		if (memcmp(a, "elapsedauto", 11)==0 && strlen(a)==11)	return symbol_engine_time.elapsedauto();
		if (memcmp(a, "elapsedtoday", 12)==0 && strlen(a)==12)	return symbol_engine_time.elapsedtoday();
	}
	...
	{
		// GENERAL
		if (memcmp(a, "isfinaltable", 12)==0 && strlen(a)==12)				return symbol_engine_autoplayer.isfinaltable();
		...
		// HAND TESTS 2(2)
		if (memcmp(a, "ishandup", 8)==0 && strlen(a)==8)					return symbol_engine_cards.ishandup(); 
		if (memcmp(a, "ishandupcommon", 14)==0 && strlen(a)==14)			return symbol_engine_cards.ishandupcommon();
		if (memcmp(a, "ishicard", 8)==0 && strlen(a)==8)					return symbol_engine_cards.ishicard();
		if (memcmp(a, "isonepair", 9)==0 && strlen(a)==9)					return symbol_engine_cards.isonepair();
		if (memcmp(a, "istwopair", 9)==0 && strlen(a)==9)					return symbol_engine_cards.istwopair();
		if (memcmp(a, "isthreeofakind", 14)==0 && strlen(a)==14)			return symbol_engine_cards.isthreeofakind();
		if (memcmp(a, "isstraight", 10)==0 && strlen(a)==10)				return symbol_engine_cards.isstraight();
		if (memcmp(a, "isflush", 7)==0 && strlen(a)==7)						return symbol_engine_cards.isflush();
		if (memcmp(a, "isfullhouse", 11)==0 && strlen(a)==11)				return symbol_engine_cards.isfullhouse();
		if (memcmp(a, "isfourofakind", 13)==0 && strlen(a)==13)				return symbol_engine_cards.isfourofakind();
		if (memcmp(a, "isstraightflush", 15)==0 && strlen(a)==15)			return symbol_engine_cards.isstraightflush();
		if (memcmp(a, "isroyalflush", 12)==0 && strlen(a)==12)				return symbol_engine_cards.isroyalflush();

		// POCKET TESTS
		if (memcmp(a, "ispair", 6)==0 && strlen(a)==6)						return symbol_engine_cards.ispair()
		if (memcmp(a, "issuited", 8)==0 && strlen(a)==8)					return symbol_engine_cards.issuited();
		if (memcmp(a, "isconnector", 11)==0 && strlen(a)==11)				return symbol_engine_cards.isconnector();

		// POCKET/COMMON TESTS
		if (memcmp(a, "ishipair", 8)==0 && strlen(a)==8)					return symbol_engine_pokerval.ishipair();
		if (memcmp(a, "islopair", 8)==0 && strlen(a)==8)					return symbol_engine_pokerval.islopair();
		if (memcmp(a, "ismidpair", 9)==0 && strlen(a)==9)					return symbol_engine_pokerval.ismidpair();
		if (memcmp(a, "ishistraight", 12)==0 && strlen(a)==12)				return symbol_engine_pokerval.ishistraight();
		if (memcmp(a, "ishiflush", 9)==0 && strlen(a)==9)					return symbol_engine_pokerval.ishiflush();

		// AUTOPLAYER 2(2)
		if (memcmp(a, "ismyturn", 8)==0 && strlen(a)==8)					return symbol_engine_autoplayer.ismyturn();
		if (memcmp(a, "issittingin", 11)==0 && strlen(a)==11)				return symbol_engine_autoplayer.issittingin();
		if (memcmp(a, "issittingout", 12)==0 && strlen(a)==12)				return symbol_engine_autoplayer.issittingout();
		if (memcmp(a, "isautopost", 10)==0 && strlen(a)==10)				return symbol_engine_autoplayer.isautopost();
		if (memcmp(a, "isfinalanswer", 13)==0 && strlen(a)==13)				return symbol_engine_autoplayer.isfinalanswer();
	}

	// HAND TESTS 1(2)
	if (memcmp(a, "$", 1)==0)
	{
		if (memcmp(a, "$$pc", 4)==0)										return symbol_engine_cards.$$pc(a[4]-'0');
		if (memcmp(a, "$$pr", 4)==0)										return symbol_engine_cards.$$pr(a[4]-'0');
		if (memcmp(a, "$$ps", 4)==0)  										return symbol_engine_cards.$$ps(a[4]-'0');
		if (memcmp(a, "$$cc", 4)==0)  										return symbol_engine_cards.$$cc(a[4]-'0');
		if (memcmp(a, "$$cr", 4)==0)  										return symbol_engine_cards.$$cr(a[4]-'0');
		if (memcmp(a, "$$cs", 4)==0)  										return symbol_engine_cards.$$cs(a[4]-'0');
		if (memcmp(a, "$", 1)==0)  											return symbol_engine_cards.IsHand(a, e);
	}

	// POKER VALUES 1(2)
	if (memcmp(a, "pokerval", 8)==0)
	{
		if (memcmp(a, "pokerval", 8)==0 && strlen(a)==8)					return symbol_engine_pokerval.pokerval();
		if (memcmp(a, "pokervalplayer", 14)==0 && strlen(a)==14)			return symbol_engine_pokerval.pokervalplayer();
		if (memcmp(a, "pokervalcommon", 14)==0 && strlen(a)==14)			return symbol_engine_pokerval.pokervalcommon();
	}

	// (UN) KNOWN CARDS 1(3)
	if (memcmp(a, "ncards", 6)==0)
	{
		if (memcmp(a, "ncardsknown", 11)==0 && strlen(a)==11)				return symbol_engine_cards.ncardsknown();
		if (memcmp(a, "ncardsunknown", 13)==0 && strlen(a)==13)				return symbol_engine_cards..ncardsunknown();
		if (memcmp(a, "ncardsbetter", 12)==0 && strlen(a)==12)				return symbol_engine_cards..ncardsbetter();
	}
	...
	if (memcmp(a, "pr", 2)==0)
	{
		// PROBABILITIES
		// Part 2(2)
		if (memcmp(a, "prwin", 5)==0 && strlen(a)==5)						return symbol_engine_prwin.prwin;
		if (memcmp(a, "prlos", 5)==0 && strlen(a)==5)						return symbol_engine_prwin.prlos;
		if (memcmp(a, "prtie", 5)==0 && strlen(a)==5)						return symbol_engine_prwin.prtie;

		//NHANDS 2(2)
		if (memcmp(a, "prwinnow", 8)==0 && strlen(a)==8)					return symbol_engine_prwin.prwinnow();
		if (memcmp(a, "prlosnow", 8)==0 && strlen(a)==8)					return symbol_engine_prwin.prlosnow();
	}

	// FLUSHES SETS STRAIGHTS 1(5)
	if (memcmp(a, "nsuited", 7)==0)
	{
		if (memcmp(a, "nsuited", 7)==0 && strlen(a)==7)						return symbol_engine_cards.nsuited();
		if (memcmp(a, "nsuitedcommon", 13)==0 && strlen(a)==13)				return symbol_engine_cards.nsuitedcommon();
	}

	// FLUSHES SETS STRAIGHTS 2(5)
	if (memcmp(a, "tsuit", 5)==0)
	{
		if (memcmp(a, "tsuit", 5)==0 && strlen(a)==5)						return symbol_engine_cards.tsuit;
		if (memcmp(a, "tsuitcommon", 11)==0 && strlen(a)==11)				return symbol_engine_cards.tsuitcommon;
	}

	// FLUSHES SETS STRAIGHTS 3(5)
	if (memcmp(a, "nranked", 7)==0)
	{
		if (memcmp(a, "nranked", 7)==0 && strlen(a)==7)						return symbol_engine_pokerval.nranked;
		if (memcmp(a, "nrankedcommon", 13)==0 && strlen(a)==13)				return symbol_engine_pokerval.nrankedcommon;
	}

	// FLUSHES SETS STRAIGHTS 4(5)
	if (memcmp(a, "trank", 5)==0)
	{
		if (memcmp(a, "trank", 5)==0 && strlen(a)==5)						return symbol_engine_pokerval.trank;
		if (memcmp(a, "trankcommon", 11)==0 && strlen(a)==11)				return symbol_engine_pokerval.trankcommon;
	}

	// FLUSHES SETS STRAIGHTS 5(5)
	if (memcmp(a, "nstraight", 9)==0)
	{
		if (memcmp(a, "nstraight", 9)==0 && strlen(a)==9)					return symbol_engine_cards.nstraight;
		if (memcmp(a, "nstraightcommon", 15)==0 && strlen(a)==15)			return symbol_engine_cards.nstraightcommon;
		if (memcmp(a, "nstraightfill", 13)==0 && strlen(a)==13)				return symbol_engine_cards.nstraightfill;
		if (memcmp(a, "nstraightfillcommon", 19)==0 && strlen(a)==19)		return symbol_engine_cards.nstraightfillcommon;
		if (memcmp(a, "nstraightflush", 14)==0 && strlen(a)==14)			return symbol_engine_cards.nstraightflush;
		if (memcmp(a, "nstraightflushcommon", 20)==0 && strlen(a)==20)		return symbol_engine_cards.nstraightflushcommon;
		if (memcmp(a, "nstraightflushfill", 18)==0 && strlen(a)==18)		return symbol_engine_cards.nstraightflushfill;
		if (memcmp(a, "nstraightflushfillcommon", 24)==0 && strlen(a)==24)  return symbol_engine_cards.nstraightflushfillcommon;
	}

	// LIMITS 2(3)
	if (memcmp(a, "srai", 4)==0)
	{
		if (memcmp(a, "sraiprev", 8)==0 && strlen(a)==8)					return symbol_engine_chip_amounts.sraiprev();
		if (memcmp(a, "sraimin", 7)==0 && strlen(a)==7)						return symbol_engine_chip_amounts.sraimin();
		if (memcmp(a, "sraimax", 7)==0 && strlen(a)==7)						return symbol_engine_chip_amounts.sraimax();
	}
	...
	{
		// CHIP AMOUNTS 1(2)
		if (memcmp(a, "pot", 3)==0 && strlen(a)==3)							return symbol_engine_chip_amounts.pot();
		if (memcmp(a, "potcommon", 9)==0 && strlen(a)==9)					return symbol_engine_chip_amounts.potcommon();
		if (memcmp(a, "potplayer", 9)==0 && strlen(a)==9)					return symbol_engine_chip_amounts.potplayer();
	}
	...
	//
	// CHAIRS 2(2)	
	if (memcmp(a, "userchair", 9)==0 && strlen(a)==9)					return symbol_engine_userchair.userchair();
	if (memcmp(a, "dealerchair", 11)==0 && strlen(a)==11)				return symbol_engine_dealerchair.dealerchair();
	if (memcmp(a, "raischair", 9)==0 && strlen(a)==9)					return symbol_engine_raisers_callers.raischair();

	//ROUND&POSITIONS
	if (memcmp(a, "betround", 8)==0 && strlen(a)==8)					return _sym.betround;
	if (memcmp(a, "betposition", 11)==0 && strlen(a)==11)				return symbol_engine_positions.betposition();
	if (memcmp(a, "dealposition", 12)==0 && strlen(a)==12)				return symbol_engine_positions.dealposition();
	if (memcmp(a, "callposition", 12)==0 && strlen(a)==12)				return symbol_engine_positions.callposition;
	if (memcmp(a, "dealpositionrais", 16)==0 && strlen(a)==16)			return symbol_engine_positions.dealpositionrais();
	if (memcmp(a, "betpositionrais", 15)==0 && strlen(a)==15)			return symbol_engine_positions.betpositionrais();
	if (memcmp(a, "originaldealposition", 20)==0 && strlen(a)==20)		return _sym.originaldealposition; //Matrix 2008-05-09

	//CHIP AMOUNTS 2(2)
	if (memcmp(a, "balance", 7)==0 && strlen(a)==7)						return symbol_engine_chip_amounts.balance(userchair);
	if (memcmp(a, "balance", 7)==0 && strlen(a)==8)						return symbol_engine_chip_amounts.balance(a[7]-'0');
	if (memcmp(a, "maxbalance", 10)==0 && strlen(a)==10)  				return symbol_engine_chip_amounts.maxbalance();
	if (memcmp(a, "balanceatstartofsession", 23)==0 && strlen(a)==24)	return symbol_engine_chip_amounts.balanceatstartofsession();
	if (memcmp(a, "stack", 5)==0 && strlen(a)==6)						return symbol_engine_chip_amounts.stack(a[5]-'0');
	if (memcmp(a, "currentbet", 10)==0 && strlen(a)==10)				return symbol_engine_chip_amounts.currentbet(userchair)
	if (memcmp(a, "currentbet", 10)==0 && strlen(a)==11)				return symbol_engine_chip_amounts.currentbet(a[10]-'0');
	if (memcmp(a, "call", 4)==0 && strlen(a)==4)						return symbol_engine_chip_amounts.call();
	if (memcmp(a, "bet", 3)==0 && strlen(a)==3)							return p_tablelimits->bet();
	if (memcmp(a, "bet", 3)==0 && strlen(a)==4)							return p_tablelimits->bet(a[3]-'0');
	
	//NUMBER OF BETS
	if (memcmp(a, "nbetstocall", 11)==0 && strlen(a)==11)				return symbol_engine_chip_amounts.nbetstocall()
	if (memcmp(a, "nbetstorais", 11)==0 && strlen(a)==11)				return symbol_engine_chip_amounts.nbetstorais();
	if (memcmp(a, "ncurrentbets", 12)==0 && strlen(a)==12)				return symbol_engine_chip_amounts.ncurrentbets();
	if (memcmp(a, "ncallbets", 9)==0 && strlen(a)==9)					return symbol_engine_chip_amounts.ncallbets();
	if (memcmp(a, "nraisbets", 9)==0 && strlen(a)==9)					return symbol_engine_chip_amounts.nraisbets();

	//POKER VALUES 2(2)	
	if (memcmp(a, "pcbits", 6)==0 && strlen(a)==6)						return symbol_engine_pokerval.pcbits;
	if (memcmp(a, "npcbits", 7)==0 && strlen(a)==7)						return symbol_engine_pokerval.npcbits;
	...
	if (memcmp(a, "bblindbits", 10)==0 && strlen(a)==10)  				return symbol_engine_blinds.bblindbits();
	if (memcmp(a, "raisbits", 8)==0 && strlen(a)==9)  					return symbol_engine_raisers_callers.raisbits(a[8]-'0');
	if (memcmp(a, "callbits", 8)==0 && strlen(a)==9)  					return symbol_engine_raisers_callers.callbits(a[8]-'0');
	if (memcmp(a, "foldbits", 8)==0 && strlen(a)==9)  					return symbol_engine_raisers_callers.foldbits(a[8]-'0');
	...
	//(UN)KNOWN CARDS 3(3)
	if (memcmp(a, "nouts", 5)==0 && strlen(a)==5)						return symbol_engine_cards.nouts();

	// HISTORY S
	// Part 3(3)
	if (memcmp(a, "prevaction", 10)==0 && strlen(a)==10)				return symbol_engine_history.prevaction();
	if (memcmp(a, "nbetsround", 10)==0 && strlen(a)==10)				return symbol_engine_history.nbetsround(_betround)
	if (memcmp(a, "nbetsround", 10)==0 && strlen(a)==11)				return symbol_engine_history.nbetsround(a[10]-'0');
	...
	// AUTOPLAYER 1(2)
	if (memcmp(a, "myturnbits", 10)==0 && strlen(a)==10)				return symbol_engine_autoplayer.myturnbits();
