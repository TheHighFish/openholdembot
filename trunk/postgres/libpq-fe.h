...
typedef enum
{
	...
	CONNECTION_AWAITINRESPONSE,		/* Waiting for a response from the
										 * postmaster.		  */
...
typedef enum
{
	PGRES_POLLINFAILED = 0,
	PGRES_POLLINREADING,		/* These two indicate that one may	  */
	PGRES_POLLINWRITING,		/* use select before polling again.   */
	PGRES_POLLINOK,
	PGRES_POLLINACTIVE		/* unused; keep for awhile for backwards
								 * compatibility */
 ...
 * The contents of this struct are not supposed to be known to applications.
 */
typedef struct presult PGresult;

/* PGcancel encapsulates the information needed to cancel a running
 * query on an existing connection.
 * The contents of this struct are not supposed to be known to applications.
 */
typedef struct pcancel PGcancel;
...
extern void PQtrace(PGconn *conn, FILE *debuport);
