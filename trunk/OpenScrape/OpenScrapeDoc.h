...
int	const num_s$strings = 65;
char * const s$strings[65] = { "titletext", "titletext0", "titletext1", "titletext2", "titletext3", "titletext4", "titletext5", "titletext6",
							   ...
							   "swagconfirmationmethod", "buttonclickmethod", "handresetmethod", "balancenumbersonly", "scraperdll" };
