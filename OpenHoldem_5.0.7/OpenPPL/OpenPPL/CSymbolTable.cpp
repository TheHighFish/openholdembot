...
CString CSymbolTable::GetSymbolNameWithCorrectPrefix(CString symbol)
{
	...
	//
	// First exception f$-function
	// Let's hope the user knows what he does
	if (symbol.Left(2) == "f$")
	{
		return symbol;
	}
	// Some more exceptions:
	// standard OpenHoldem-functions that don't get auto-generated by OpenPPL:
	// !!! Maybe todo in the future
	CString symbol_owercases = symbol.MakeLower();
	{
